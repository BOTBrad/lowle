...
var $author$project$Lowle$allAnswers = _List_fromArray(
...
var $author$project$Lowle$random_index = A2(
	$elm$random$Random$int,
	0,
	$elm$core$List$length($author$project$Lowle$allAnswers) - 1);
var $author$project$Lowle$init = function (_v0) {
	return _Utils_Tuple2(
		{G: '', r: '', x: _List_Nil},
		A2($elm$random$Random$generate, $author$project$Lowle$NewAnswer, $author$project$Lowle$random_index));
};
var $elm$core$Platform$Sub$batch = _Platform_batch;
var $elm$core$Platform$Sub$none = $elm$core$Platform$Sub$batch(_List_Nil);
var $author$project$Lowle$subscriptions = function (model) {
...
var $author$project$Lowle$get_answer = function (idx) {
	return A2(
		...
		A2(
			$elm$core$Array$get,
			idx,
			$elm$core$Array$fromList($author$project$Lowle$allAnswers)));
};
var $elm$core$Platform$Cmd$batch = _Platform_batch;
var $elm$core$Platform$Cmd$none = $elm$core$Platform$Cmd$batch(_List_Nil);
var $elm$core$Basics$not = _Basics_not;
var $author$project$Lowle$allGuesses = _List_fromArray(
...
var $author$project$Lowle$validate = function (guess) {
	var check = $elm$core$List$member(guess);
	return check($author$project$Lowle$allAnswers) || check($author$project$Lowle$allGuesses);
};
var $author$project$Lowle$update = F2(
	function (msg, model) {
		switch (msg.$) {
			case 2:
				return _Utils_Tuple2(
			...
			case 3:
				...
				return _Utils_Tuple2(
					_Utils_update(
						model,
						{
							G: $author$project$Lowle$get_answer(idx),
							x: _List_Nil
						}),
			...
			default:
				return _Utils_Tuple2(
					(!$author$project$Lowle$validate(model.r)) ? model : _Utils_update(
						model,
						{
							r: '',
							x: A2($elm$core$List$cons, model.r, model.x)
						}),
					$elm$core$Platform$Cmd$none);
		}
	});
var $author$project$Lowle$Change = function (a) {
	return {$: 0, a: a};
};
var $author$project$Lowle$Guess = {$: 1};
var $author$project$Lowle$Reset = {$: 2};
...
var $author$project$Lowle$comp_letter = F2(
	function (a_char, g_char) {
		var a = $elm$core$Char$toCode(a_char);
		var g = $elm$core$Char$toCode(g_char);
		var bgc = (_Utils_cmp(a, g) < 0) ? 'Plum' : ((_Utils_cmp(a, g) > 0) ? 'SkyBlue' : 'Chartreuse');
		return A2(
			$elm$html$Html$div,
			_List_fromArray(
				[
					A2($elm$html$Html$Attributes$style, 'background-color', bgc),
			...
			_List_fromArray(
				[
					$elm$html$Html$text(
					$elm$core$String$fromChar(g_char))
				]));
	});
...
var $author$project$Lowle$compare = F2(
	function (answer, guess) {
		return A2(
			...
			A3(
				$elm$core$List$map2,
				$author$project$Lowle$comp_letter,
				$elm$core$String$toList(answer),
				$elm$core$String$toList(guess)));
	});
var $elm$html$Html$form = _VirtualDom_node('form');
var $author$project$Lowle$guide = A2(
	$elm$html$Html$div,
	_List_Nil,
	A2(
		$elm$core$List$map,
		...
		_List_fromArray(
			[
				_Utils_Tuple2('Plum', 'high'),
				_Utils_Tuple2('SkyBlue', 'low'),
				_Utils_Tuple2('Chartreuse', 'correct')
			])));
